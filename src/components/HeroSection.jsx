export const HeroSection = () => {
  return (
    <div className="relative w-full h-full px-4">
      ...
      <div className="absolute inset-x-0 bottom-0 space-y-6 z-20">
        ...
        <section className="flex flex-col mb-4">
          <span className="font-druk text-center text-[15.7vw]/[80px] sm:text-[15.7vw]/[100px] md:text-[15.3vw]/[130px] lg:text-[14.6vw]/[170px] text-brand">
